...
public class UserReview {
	...
	@Id
	@Field("id")
	private CompositeKey previousApiId;
    ...
    public static class CompositeKey implements Serializable {
		 ...
		 * 
		 */
		private static final long serialVersionUID = -1107889550765127672L;
		private Long userId;
    	private Long itemId;
	...
	public CompositeKey getPreviousApiId() {
		return previousApiId;
	}
	public void setPreviousApiId(CompositeKey previousApiId) {
