...
import com.initializers.api.exception.OrderConfigurationException;
import com.initializers.api.extras.ApplicationProperties;
import com.initializers.api.extras.EvaluateString;
import com.initializers.api.model.OfferConfigurationDB;
import com.initializers.api.repo.OfferConfigurationDBRepo;
	...
	public Map<Object, Object> resolveFieldValue(Object object, List<String> fieldInList) {
		...
		for (String fieldInInst : fieldInList) {
			...
			if (fieldIn.length < 2) {
				...
				throw new OrderConfigurationException("invalid in orderconfiguration");
			}
